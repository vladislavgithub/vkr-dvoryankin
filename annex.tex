...
% Локальное переопределение \image в приложении Б: спецификатор [H]
% из пакета float фиксирует рисунок строго в указанном месте
% и не даёт ему «плавать» в следующий подраздел.
