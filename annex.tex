...
\begin{center}
{\fontsize{16pt}{19pt}\bfseries\selectfont ПРИЛОЖЕНИЕ А\par}
\vspace{0.5\baselineskip}
{\fontsize{14pt}{17pt}\bfseries\selectfont Фрагменты исходного кода\par}
\end{center}
\vspace{\baselineskip}
...
\begin{center}
{\fontsize{16pt}{19pt}\bfseries\selectfont ПРИЛОЖЕНИЕ Б\par}
\vspace{0.5\baselineskip}
{\fontsize{14pt}{17pt}\bfseries\selectfont Скриншоты интерфейса\par}
\end{center}
\vspace{\baselineskip}
...
\begin{center}
{\fontsize{16pt}{19pt}\bfseries\selectfont ПРИЛОЖЕНИЕ В\par}
\vspace{0.5\baselineskip}
{\fontsize{14pt}{17pt}\bfseries\selectfont Протоколы педагогического эксперимента\par}
\end{center}
\vspace{\baselineskip}
...
\begin{center}
{\fontsize{16pt}{19pt}\bfseries\selectfont ПРИЛОЖЕНИЕ Г\par}
\vspace{0.5\baselineskip}
{\fontsize{14pt}{17pt}\bfseries\selectfont Список сокращений и обозначений\par}
\end{center}
\vspace{\baselineskip}
