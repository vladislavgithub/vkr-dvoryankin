...
\newpage
\phantomsection
\section*{ПРИЛОЖЕНИЕ В. СПИСОК СОКРАЩЕНИЙ И ОБОЗНАЧЕНИЙ} \label{application_V}
\addcontentsline{toc}{section}{ПРИЛОЖЕНИЕ В. Список сокращений и обозначений}

\needspace{8\baselineskip}
\subsection*{В.1\quad Аббревиатуры}
...
\needspace{8\baselineskip}
\subsection*{В.2\quad Основные обозначения}
...
\begin{description}
    ...
    \item[$\alpha$] --- коэффициент $\alpha$ Кронбаха (психометрика).
