...
\usepackage{titlesec}
% Метка заголовка («ГЛАВА N.», «N.M.») сдвинута на 1.25 см от
% левого края (как абзацный отступ). Если заголовок переносится
% на следующую строку — продолжение идёт с края (положение 0).
\titleformat{\section}
    {\fontsize{16pt}{19pt}\bfseries\raggedright\selectfont}
    {\hspace*{1.25cm}\thesection.}{0.5em}{\MakeUppercase}
% Введение, Заключение — без метки, поэтому без abспэйса.
\titleformat{name=\section,numberless}
    {\fontsize{14pt}{17pt}\bfseries\raggedright\selectfont}
    {}{0pt}{}
