...
% Имена «Рисунок» и «Таблица» — через captionsrussian (после polyglossia).
% labelsep уже задан опцией пакета caption, точку добавлял misccorr (отключён).
\addto\captionsrussian{%
    \renewcommand{\figurename}{Рисунок}%
    \renewcommand{\tablename}{Таблица}%
}
% Отдельные настройки выравнивания и позиции — глобально в preamble.
% Внутри captionsrussian они кэшируются неправильно и не применяются.
