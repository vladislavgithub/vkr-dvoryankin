...
% Подписи рисунков центрируются (default), подписи таблиц
% выравниваются по правому краю и стоят над таблицей.
% Применяем через \AtBeginDocument: иначе polyglossia/babel сбрасывает
% labelsep при активации русского языка, и подпись становится
% «Таблица 1.1. ...» вместо требуемого «Таблица 1.1 — ...».
\AtBeginDocument{%
