...
\usepackage{caption}
% В пакете caption нет встроенного labelsep=emdash; определяем свой
% разделитель как длинное тире (—), как требуют ГОСТ 7.32-2017
% и методичка кафедры АСУ: «Рисунок N — Описание».
